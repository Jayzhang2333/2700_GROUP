...
getcSCI1:
            ldx   #RAMStart
read:       brclr SCI1SR1, SCI1SR1_RDRF,read
            ldaa  SCI1DRL
            staa  1,x+
...
write_char:    
            brclr SCI1SR1,mSCI0SR1_TDRE,write_char      ; if the TDRE flag is cleared, indicating that the DRL is not cleared, loop back again to keep sending data. else, go on
